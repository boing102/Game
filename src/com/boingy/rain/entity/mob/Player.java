...
public class Player extends Mob {
	...
	private int anim = 0;
	private double speed = 2; //Ked je nepekne desatine cislo, chaser sa zacne bugovat, pekne zaokruhluj...
	...
	public void update() {
		List<Entity> es = level.getEntities(this, 50);
		System.out.println("player X possition: " + this.x);
